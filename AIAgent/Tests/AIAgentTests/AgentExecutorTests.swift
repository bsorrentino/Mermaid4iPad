...
"""
    ...
    func testCodableDiagramDescriptionOutput() async throws {
        ...
        let diagram =
"""
{\n  \"type\": \"flowchart\",\n  \"title\": \"Diagram Translation Process\",\n  \"participants\": [\n    { \"name\": \"Describe Diagram\", \"shape\": \"rectangle\", \"description\": \"Initial step to describe the diagram\" },\n    { \"name\": \"Check Type\", \"shape\": \"rectangle\", \"description\": \"Check the type of diagram\" },\n    { \"name\": \"Sequence\", \"shape\": \"rectangle\", \"description\": \"Option for a sequence diagram\" },\n    { \"name\": \"Generic\", \"shape\": \"rectangle\", \"description\": \"Option for a generic diagram\" },\n    { \"name\": \"Mermaid Sequence\", \"shape\": \"rectangle\", \"description\": \"Command to generate a sequence diagram with Mermaid\" },\n    { \"name\": \"Mermaid Generic\", \"shape\": \"rectangle\", \"description\": \"Command to generate a generic diagram with Mermaid\" },\n    { \"name\": \"Stop\", \"shape\": \"ellipse\", \"description\": \"End of process\" }\n  ],\n  \"relations\": [\n    { \"source\": \"Describe Diagram\", \"target\": \"Check Type\", \"description\": \"Leads to checking the diagram type\" },\n    { \"source\": \"Check Type\", \"target\": \"Sequence\", \"description\": \"Option selected for sequence diagrams\" },\n    { \"source\": \"Check Type\", \"target\": \"Generic\", \"description\": \"Option selected for generic diagrams\" },\n    { \"source\": \"Sequence\", \"target\": \"Mermaid Sequence\", \"description\": \"Leads to Mermaid sequence diagram creation\" },\n    { \"source\": \"Generic\", \"target\": \"Mermaid Generic\", \"description\": \"Leads to Mermaid generic diagram creation\" },\n    { \"source\": \"Mermaid Sequence\", \"target\": \"Stop\", \"description\": \"Ends the sequence diagram process\" },\n    { \"source\": \"Mermaid Generic\", \"target\": \"Stop\", \"description\": \"Ends the generic diagram process\" }\n  ],\n  \"containers\": [],\n  \"description\": \"The flowchart initiates with \'Describe Diagram\', followed by \'Check Type\' to determine if the diagram is a \'Sequence\' or \'Generic\' diagram. According to the type, it either proceeds to \'Mermaid Sequence\' or \'Mermaid Generic\' for execution. The process concludes at the \'Stop\' step.\"\n}"
"""
