...
public struct ActivityView<Content>: View where Content: View {
    ...
    public init( isShowing: Bool, label: String, content: @escaping () -> Content) {
...
extension ActivityView {
    ...
    public func onCancel( _ cancel: @escaping  () -> Void) -> some View {
...
#Preview {
    ...
    struct MyPreview : View {
        ...
        var body: some View {
            ActivityView(isShowing: isShowing, label: "Loading process\nand other" ) {
