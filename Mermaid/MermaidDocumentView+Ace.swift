    ...
    var body: some View {
        ...
        VStack {
            GeometryReader { geometry in
                ...
                VStack {
                    AceEditorView( content: $document.text, options: options )
                    .id( editorViewId )
        ...
        var body: some View {
            HStack(alignment: .bottom, spacing: 5) {
                if( saving ) {
                    ...
                    if visible {
                        MermaidDocumentViewAce.SavedStateView( visible: $visible )
                    }
                }
            }
...
"""
    ...
    return NavigationStack {
        MermaidDocumentViewAce( document: MermaidObservableDocument(
